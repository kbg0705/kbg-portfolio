...
export const projectDetails: ProjectDetail[] = [
  ...
  },
  {
    ...
    keyDecisions: [
      {
        title: 'FO와 BO를 함께 설계',
        problem: '파일 오류와 주문 정보 누락이 고객의 재작업뿐 아니라 운영자의 반복 확인 업무로 이어졌습니다.',
        judgment: '고객 화면의 안내만 바꾸면 접수, 검수, 공장 입력 과정의 수작업은 그대로 남는다고 봤습니다.',
        decision: '주문, 파일 첨부, 검수, 배송 정보를 FO 주문 흐름과 BO 처리 기준에서 함께 정의했습니다.',
      },
      {
        title: '플랫폼 제약 안에서 핵심 행동 우선 개선',
        problem: 'Cafe24 주문 구조와 내부 인트라넷 연동 조건 때문에 주문 단계를 전면 재구성하기 어려웠습니다.',
        judgment: '전면 재개발보다 고객이 가장 자주 막히는 업로드 시점과 운영 데이터 연결 지점을 먼저 줄이는 것이 현실적이었습니다.',
        decision: '상품별 파일 가이드, 확인 CTA, 주문 CSV와 내부 업무 필드 매핑을 핵심 행동 기준으로 설계했습니다.',
      },
      {
        title: '주문 후 처리보다 주문 전 예방',
        problem: '작업 파일 오류가 주문 완료 후 발견되면서 CS와 재작업으로 이어졌습니다.',
        judgment: '사후 확인보다 주문 전에 제작 기준을 확인하게 하는 편이 고객과 운영자 모두의 시간을 줄일 수 있다고 판단했습니다.',
        decision: '오류 가능성이 높은 업로드 단계에 안내, 대표 오류 예시, 파일 제작 기준 확인 흐름을 배치했습니다.',
      },
    ],
