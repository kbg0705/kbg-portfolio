...
export function PortfolioHomePage() {
  ...
  return <><Header /><main>
    <section className="home-hero">
      <div><p className="eyebrow">PRODUCT MANAGER · UX STRATEGY · AI</p><h1>사용자의 막힘을 발견해<br /><span>실행 가능한 제품으로 바꿉니다.</span></h1><p>{profile.profile[1]}</p><div className="hero-actions"><a className="primary-action" href="#featured">프로젝트 살펴보기 <ArrowRight size={18} /></a><Link className="secondary-action" to="/about#career-summary">경력 한눈에 보기</Link></div></div>
